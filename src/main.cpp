 ...
 *
 * BUILD
 *   PlatformIO: pio run -t upload    (see platformio.ini)
 *   Arduino IDE: board XIAO_ESP32C3, USB CDC On Boot: Enabled, Flash Mode DIO.
 *   Copy src/config.example.h to src/config.h and fill in credentials.
 *
